...
<section
    ...
    <img src="{{ asset('storage/' . $hero->additional_image ?? 'images/mangena-hero.png') }}" class="position-absolute top-35 left-minus-100px left-img d-none d-md-block"
                ...
                <div class="ps-20">
                    ...
                    <div class="top-minus-40px sm-top-minus-20px right-minus-3px sm-right-0px position-relative">
                        ...
                        <span
                            ...
                            {{ $hero->role ?? 'Data Analyst' }}</span>

                            {{-- description here --}}
                        <div class="fs-15 lh-26 text-black fw-500 w-65 md-w-70 sm-w-100">{{ $hero->description ?? 'Transforming complex data into actionable insights...' }}

                           <span
                                class="fw-700 text-decoration-line-bottom-medium text-black"></span></div>
                    </div>
                </div>
            </div>
            <div
                ...
                <img src="{{ asset('images/demo-freelancer-04.png') }}"
                        ...
                        <div class="atropos-rotate">
                            <div class="atropos-inner text-center">
                                <div data-atropos-offset="-5" class="position-absolute left-0px right-0px">
                                    <img src="{{ asset('images/demo-freelancer-01.png') }}" alt="">
                                </div>
                                ...
                                <img data-atropos-offset="5" class="position-relative "
                                    src="{{ asset('storage/' . $hero->main_image ?? 'images/mangena-hero-two-Photoroom.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                ...
                <div class="row mb-6">
                    <div class="col-xl-4 col-lg-5"
                        data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <h4 class="fw-700 ls-minus-1px mb-20px">Who is Tafadzwa ?</h4>
                        <p class="w-85 lg-w-100">Currently improving users experience and interface design as lead
                            designer director at crafto theme agency.</p>
                    ...
                    <div class="col-xl-8 col-lg-7"
                        ...
                        <div
                            ...
                            <div class="col-md-9 last-paragraph-no-margin">
                                <p>I'm a dedicated data analyst with a passion for transforming complex datasets into
                                    clear, actionable insights. My journey in analytics has been driven by curiosity and
                                    a commitment to leveraging data to solve real-world business problems.</p>
                            </div>
                        </div>
                        <div
                            class="row align-items-center border-bottom border-color-light-medium-gray mb-30px pb-30px">
                            ...
                            <div class="col-md-9 last-paragraph-no-margin">
                                <p>I believe in rigorous analysis, critical thinking, and presenting findings in a way
                                    that drives decision-making. I'm actively seeking opportunities where I can
                                    contribute my expertise in data visualization, statistical analysis, and business
                                    intelligence to help organizations achieve their strategic goals.</p>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4 project-col">
                        <div class="project-card">
                            ...
                            <div class="mobile-card-body">
                                ...
                                <a href="{{ route('project') }}" class="read-more">Read More <svg width="11" height="11"
    ...
    <div id="expertise" class="container overflow-y-hidden">
        <div class="row align-items-end flex-column-reverse flex-lg-row">
            ...
            <div class="col-lg-5 mb-6 mt-6 md-mb-0"
                ...
                <p class="w-90 text-black xl-w-100">Lorem Currently improving users experience and interface design as
                    lead designer director at crafto agency. Creating brand identities and experiences.</p>
                <div class="progress-bar-style-01 mt-14 d-block">
                    <!-- start progress bar item -->
                    <div class="progress mb-12 sm-mb-20 bg-transparent">
                        <div class="progress-bar-title d-inline-block text-black text-uppercase fs-14 fw-600">Web
                            design</div>
                        <div class="progress-bar bg-black" role="progressbar" aria-valuenow="80" aria-valuemin="0"
                            aria-valuemax="100" aria-label="web-design">
                    ...
                    <!-- start progress bar item -->
                    <div class="progress mb-12 sm-mb-20 bg-transparent">
                        <div class="progress-bar-title d-inline-block text-black text-uppercase fs-14 fw-600">Graphic
                            design</div>
                        <div class="progress-bar bg-black" role="progressbar" aria-valuenow="98" aria-valuemin="0"
                            aria-valuemax="100" aria-label="graphic-design">
                    ...
                    <!-- start progress bar item -->
                    <div class="progress mb-12 sm-mb-20 bg-transparent">
                        <div class="progress-bar-title d-inline-block text-black text-uppercase fs-14 fw-600">Art
                            direction</div>
                        <div class="progress-bar bg-black" role="progressbar" aria-valuenow="85" aria-valuemin="0"
                            aria-valuemax="100" aria-label="art-direction">
