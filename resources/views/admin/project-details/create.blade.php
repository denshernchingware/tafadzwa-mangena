...
@section('title', 'Create Project Detail - Admin')
@section('page-title', 'Create Project Detail')
@section('content')
<form method="POST" action="{{ route('admin.project-details.store') }}" class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
    @csrf
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <input type="text" name="project_link" value="" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>
        <div class="md:col-span-2">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Tools (comma separated)</label>
            <input type="text" name="tools" value="" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>
        <div class="md:col-span-2">
