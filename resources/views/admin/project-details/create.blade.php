...
<head>
    ...
    <title>Create Project Detail - Admin</title>
...
<body class="bg-gray-100 min-h-screen">
    <nav class="bg-blue-600 text-white p-4">
        <div class="container mx-auto flex justify-between items-center">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-xl font-bold">Create Project Detail</h1>
            </div>
    ...
    <div class="container mx-auto p-6">
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('admin.project-details.store') }}" method="POST">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="link" value="" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
