...
<head>
    ...
    <title>Skill Details - Admin</title>
    ...
    <nav class="bg-blue-600 text-white p-4">
        <div class="container mx-auto flex justify-between items-center">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-xl font-bold">Skill Details</h1>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <p class="mt-1 text-lg text-gray-900">{{ $skill->id }}</p>
                </div>
                <div>
                    <h3 class="text-sm font-medium text-gray-500 uppercase">Skill</h3>
                    <p class="mt-1 text-lg text-gray-900">{{ $skill->skill }}</p>
                </div>
                <div class="md:col-span-2">
                    <h3 class="text-sm font-medium text-gray-500 uppercase">Description</h3>
                    <p class="mt-1 text-lg text-gray-900">{{ $skill->description }}</p>
                </div>
            </div>
