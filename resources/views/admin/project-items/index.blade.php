                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex gap-2">
                                <a href="/admin/project-items/{{ $item->id }}" class="text-blue-600 hover:text-blue-800">View</a>
                                <a href="/admin/project-items/{{ $item->id }}/edit" class="text-yellow-600 hover:text-yellow-800">Edit</a>
