...
@section('title', 'Create Project Item - Admin')
@section('page-title', 'Create Project Item')
@section('content')
<form method="POST" action="{{ route('admin.project-items.store') }}" enctype="multipart/form-data" class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
    @csrf
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <input type="text" name="link" value="" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>
